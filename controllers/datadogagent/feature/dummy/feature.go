...
func (f *dummyFeature) ManageClusterAgent(podTemplate *corev1.PodTemplateSpec) error {
...
// It should do nothing if the feature doesn't need to configure it.
func (f *dummyFeature) ManageNodeAgent(podTemplate *corev1.PodTemplateSpec) error { return nil }

// ManageClusterCheckRunnerAgent allows a feature to configure the ClusterCheckRunnerAgent's corev1.PodTemplateSpec
// It should do nothing if the feature doesn't need to configure it.
func (f *dummyFeature) ManageClusterCheckRunnerAgent(podTemplate *corev1.PodTemplateSpec) error {
	return nil
}
