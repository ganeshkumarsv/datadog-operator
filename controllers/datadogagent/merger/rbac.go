...
func (m *RBACManager) AddPolicyRules(namespace string, roleName string, saName string, policies []rbacv1.PolicyRule) error {
...
func (m *RBACManager) AddClusterPolicyRules(namespace string, roleName string, saName string, policies []rbacv1.PolicyRule) error {
