...
func schema__apis_datadoghq_v2alpha1_DatadogCredentials(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"apiSecret": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/DataDog/datadog-operator/apis/datadoghq/common/v1.Secret"),
						},
					},
					"appKey": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/DataDog/datadog-operator/apis/datadoghq/common/v1.Secret"},
	}
}
